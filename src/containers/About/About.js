...
export const About = (props) => {
  return (
    <section className='about fade-in'>
      ...
      <p>Golden City Tarot started in 1924 with a deck of cards and a dream. We are the premier destination for fortune telling in the Pacific Northwest. Tarot not your thing? We have crystal balls, palm readings, and aura readings, too. Remember, the future is golden at Golden City Tarot!</p>
      <h3>Visit Us</h3>
